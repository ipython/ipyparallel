...
`display_data` lets you publish _representations_ of data, such as images and html.
This `data_pub` message lets you publish _actual raw data_, sent via message buffers.
